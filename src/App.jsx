                    ...
                    {source === 'amazon' ? (
                      <div className="ctrl">
                        ...
                        <small className="hint">
                          ...
                          &ldquo;RRC-001-CO-C-RED-L&rdquo;) and stamps it into the blank space
                          near the bottom of the label &mdash; no resizing, nothing else moves.
                        </small>
                      </div>
                    ) : ownTrimmed ? (
                      <div className="ctrl">
                      ...
                      <div className="ctrl">
                        ...
                        {myntraPair && myntraSku && (
                          <small className="hint">
                            ...
                            and stamps it into the blank space near the bottom of the label
                            &mdash; no resizing, nothing else moves.
                          </small>
                        )}
